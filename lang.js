...
function applyPhonePlaceholders(t) {
  if (!t) {
    const lang = localStorage.getItem('savur_lang') || 'ru';
    t = TRANSLATIONS[lang];
  }
  if (!t) return;
...
const TRANSLATIONS = {
  ru: {
    ...
    hero_title: 'Savur – Питание, <span>которое работает</span> на тебя',
    hero_desc: 'Savur — это сервис доставки здорового питания, разработанный для тех, кто хочет чувствовать себя лучше каждый день. Наши программы созданы нутрициологами для реального результата.',
    ...
    prog_details: 'Детали', prog_min: 'Минимум 3 дня', prog_per_day: 'леев/день',
    ...
    how_title: 'Как создаются программы Savur',
    ...
    ben_title: 'Преимущества программ Savur',
    ...
    f_dur_1: '3 дня', f_dur_2: '1 неделя', f_dur_3: '2 недели', f_dur_4: '1 месяц',
    ...
    map_title: 'Мы на карте', map_sub: 'Strada Studenților 9/7, Chișinău, Молдова',
    footer_copy: '© 2026 Savur. Все права защищены.', footer_dev: 'Разработано компанией WebStudio',
    ...
    reset_hero_desc: 'Reset & Detox обеспечивает мягкий перезапуск организма без строгих ограничений. Блюда включают овощи, лёгкий белок и ингредиенты с детокс-эффектом, поддерживающие дренаж, пищеварение и сияние кожи. Программа снижает воспаление и задержку воды, давая ощущение лёгкости и стабильной энергии. Идеально для начала «свежего» этапа или подготовки к здоровому образу жизни. Подходит тем, кто чувствует тело перегруженным или усталым, и хочет ясности ума.',
    ...
    slim_hero_desc: 'Slim Sculpt поддерживает здоровое похудение и моделирование фигуры без голода. Сбалансированные блюда содержат нежирный белок, чистые углеводы и клетчатку для постепенного сжигания жира. Программа стабилизирует уровень сахара и снижает аппетит, помогая иметь более плоский живот и постоянную энергию. Идеально для тех, кто хочет видимых и устойчивых результатов, сохраняя мышечную массу. Подходит как новичкам, так и тем, кто пробовал диеты без успеха.',
    ...
    balance_hero_desc: 'Balance Daily идеально подходит для поддержания веса и полноценного сбалансированного питания. Сытные и разнообразные блюда обеспечивают стабильную энергию в течение дня и снижают тягу к еде. Программа поддерживает пищеварение, стабилизирует уровень сахара и улучшает общее самочувствие. Подходит для активных женщин и занятых людей, которые хотят питаться правильно без дополнительных усилий. Программа способствует здоровому образу жизни с тщательно подобранными продуктами, поддерживающими оптимальное функционирование организма.',
    ...
    energy_hero_desc: 'Energy Plus предназначена для активных людей, спортсменов и тех, кому нужны сытные и питательные блюда. Большие и сбалансированные порции поддерживают силу, выносливость и мышечную массу. Сложные углеводы, качественные белки и полезные жиры обеспечивают стабильную энергию и оптимальное восстановление после тренировок. Программа поддерживает метаболизм и способствует высокой производительности в течение дня. Подходит также для людей с интенсивной физической активностью или сложной работой. Energy Plus обеспечивает необходимые питательные вещества для силы, жизненной энергии и быстрого восстановления.',
    ...
    personal_hero_desc: 'Personal Plan создаётся индивидуально в соответствии с вашими целями и образом жизни. Программа начинается с анализа привычек питания и уровня активности, затем блюда персонализируются для похудения, набора мышечной массы, гормонального баланса или оптимального пищеварения. Каждый элемент, от калорий до комбинаций ингредиентов, адаптирован для поддержки вашего организма. План обеспечивает видимые и устойчивые результаты, соответствующие уникальным потребностям каждого клиента. Подходит для людей с особыми предпочтениями в питании или сложными целями. С Personal Plan питание становится надёжным инструментом для трансформации и здоровья.',
  ...
  en: {
    ...
    hero_title: 'Savur – Nutrition that <span>works for you</span>',
    hero_desc: 'Savur is a healthy food delivery service designed for those who want to feel better every day. Our programs are created by nutritionists for real results.',
    ...
    prog_details: 'Details', prog_min: 'Min. 3 days', prog_per_day: 'lei/day',
    ...
    how_title: 'How Savur programs are created',
    ...
    ben_title: 'Benefits of Savur programs',
    ...
    map_title: 'Find us on the map', map_sub: 'Strada Studenților 9/7, Chișinău, Moldova',
    footer_copy: '© 2026 Savur. All rights reserved.', footer_dev: 'Developed by WebStudio',
    p_reset: 'Reset & Detox', p_slim: 'Slim Sculpt', p_balance: 'Balance Daily', p_energy: 'Energy Plus', p_personal: 'Personal Plan',
    ...
    reset_hero_desc: 'Reset & Detox provides a gentle body reset without strict restrictions. Meals include vegetables, lean protein and detox-effect ingredients supporting drainage, digestion and skin radiance. The program reduces inflammation and water retention, giving a feeling of lightness and stable energy. Ideal for starting a fresh chapter or preparing for a healthy lifestyle. Perfect for those who feel overwhelmed or tired and want mental clarity.',
    ...
    slim_hero_desc: 'Slim Sculpt supports healthy weight loss and body shaping without hunger. Balanced meals contain lean protein, clean carbs and fiber for gradual fat burning. The program stabilizes blood sugar and reduces appetite, helping achieve a flatter stomach and constant energy. Ideal for those who want visible and lasting results while preserving muscle mass. Suitable for beginners and those who have tried diets without success.',
    ...
    balance_hero_desc: 'Balance Daily is ideal for weight maintenance and complete balanced nutrition. Satisfying and varied meals provide stable energy throughout the day and reduce food cravings. The program supports digestion, stabilizes blood sugar and improves overall wellbeing. Perfect for active women and busy people who want to eat right without extra effort. The program promotes a healthy lifestyle with carefully selected products supporting optimal body function.',
    ...
    energy_hero_desc: 'Energy Plus is designed for active people, athletes and those who need filling and nutritious meals. Large and balanced portions support strength, endurance and muscle mass. Complex carbs, quality proteins and healthy fats provide stable energy and optimal post-workout recovery. The program supports metabolism and promotes high performance throughout the day. Also suitable for people with intense physical activity or demanding jobs. Energy Plus delivers the nutrients needed for strength, vitality and fast recovery.',
    ...
    personal_hero_desc: 'Personal Plan is created individually according to your goals and lifestyle. The program begins with an analysis of eating habits and activity levels, then meals are personalized for weight loss, muscle gain, hormonal balance or optimal digestion. Every element, from calories to ingredient combinations, is adapted to support your body. The plan delivers visible and lasting results tailored to each client\'s unique needs. Suitable for people with specific dietary preferences or complex goals. With Personal Plan, nutrition becomes a reliable tool for transformation and health.',
  ...
  ro: {
    ...
    hero_title: 'Savur – Nutriție care <span>lucrează pentru tine</span>',
    hero_desc: 'Savur este un serviciu de livrare a alimentației sănătoase, creat pentru cei care vor să se simtă mai bine în fiecare zi. Programele noastre sunt elaborate de nutriționiști pentru rezultate reale.',
    ...
    prog_details: 'Detalii', prog_min: 'Min. 3 zile', prog_per_day: 'lei/zi',
    ...
    how_title: 'Cum sunt create programele Savur',
    ...
    ben_title: 'Avantajele programelor Savur',
    ...
    map_title: 'Ne găsiți pe hartă', map_sub: 'Strada Studenților 9/7, Chișinău, Moldova',
    footer_copy: '© 2026 Savur. Toate drepturile rezervate.', footer_dev: 'Dezvoltat de WebStudio',
    p_reset: 'Reset & Detox', p_slim: 'Slim Sculpt', p_balance: 'Balance Daily', p_energy: 'Energy Plus', p_personal: 'Personal Plan',
    ...
    reset_hero_desc: 'Reset & Detox ofera o resetare blanda a organismului fara restrictii stricte. Mesele includ legume, proteine usoare si ingrediente cu efect detox care sustin drenajul, digestia si stralucirea pielii. Programul reduce inflamatia si retentia de apa, oferind o senzatie de usurinta si energie stabila. Ideal pentru a incepe un nou capitol sau pentru pregatirea unui stil de viata sanatos. Potrivit pentru cei care se simt supraincarcati sau obositi si vor claritate mentala.',
    ...
    slim_hero_desc: 'Slim Sculpt sustine slabirea sanatoasa si modelarea corporala fara foame. Mesele echilibrate contin proteine slabe, carbohidrati curati si fibre pentru arderea graduala a grasimii. Programul stabilizeaza glicemia si reduce apetitul, ajutand la obtinerea unui abdomen mai plat si energie constanta. Ideal pentru cei care vor rezultate vizibile si durabile, pastrand masa musculara. Potrivit atat pentru incepatori, cat si pentru cei care au incercat diete fara succes.',
    ...
    balance_hero_desc: 'Balance Daily este ideal pentru mentinerea greutatii si nutritie completa echilibrata. Mesele consistente si variate ofera energie stabila pe tot parcursul zilei si reduc poftele alimentare. Programul sustine digestia, stabilizeaza glicemia si imbunatateste starea generala de sanatate. Potrivit pentru femei active si persoane ocupate care vor sa manance corect fara eforturi suplimentare. Programul promoveaza un stil de viata sanatos cu produse atent selectate care sustin functionarea optima a organismului.',
    ...
    energy_hero_desc: 'Energy Plus este conceputa pentru persoane active, sportivi si cei care au nevoie de mese consistente si nutritive. Portiile mari si echilibrate sustin forta, rezistenta si masa musculara. Carbohidratii complecsi, proteinele de calitate si grasimile sanatoase ofera energie stabila si recuperare optima dupa antrenamente. Programul sustine metabolismul si contribuie la performanta ridicata pe tot parcursul zilei. Potrivit si pentru persoane cu activitate fizica intensa sau munca solicitanta. Energy Plus furnizeaza nutrientii necesari pentru forta, vitalitate si recuperare rapida.',
    ...
    personal_hero_desc: 'Personal Plan este creat individual conform obiectivelor si stilului tau de viata. Programul incepe cu o analiza a obiceiurilor alimentare si a nivelului de activitate, apoi mesele sunt personalizate pentru slabit, cresterea masei musculare, echilibru hormonal sau digestie optima. Fiecare element, de la calorii la combinatii de ingrediente, este adaptat pentru a sustine organismul tau. Planul ofera rezultate vizibile si durabile adaptate nevoilor unice ale fiecarui client. Potrivit pentru persoane cu preferinte alimentare speciale sau obiective complexe. Cu Personal Plan, nutritia devine un instrument de incredere pentru transformare si sanatate.',
...
function applyLang(lang) {
  ...
  if (!t) return;
  localStorage.setItem('savur_lang', lang);
...
function initLang() {
  const saved = localStorage.getItem('savur_lang') || 'ru';
  applyLang(saved);
